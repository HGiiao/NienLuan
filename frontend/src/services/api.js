...
export const getFlexibleCompare = (params) => api.get('/api/prices/compare/flexible', { params })
export const getCompareRatings = (params) => api.get('/api/prices/compare/ratings', { params })
